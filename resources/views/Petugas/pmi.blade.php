            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="jenis_komponen"
                        ...
                        <option value="Trombosit" {{ old('jenis_komponen') == 'Trombosit' ? 'selected' : '' }}>Trombosit</option>
                        <option value="FFP" {{ old('jenis_komponen') == 'FFP' ? 'selected' : '' }}>FFP</option>
                        <option value="Kriopresipitasi" {{ old('jenis_komponen') == 'Kriopresipitasi' ? 'selected' : '' }}>Kriopresipitasi</option>
                    </select>
