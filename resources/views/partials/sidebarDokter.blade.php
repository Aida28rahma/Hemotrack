<div class="w-64 min-h-[calc(100vh-86px)] bg-gradient-to-b from-[#0f4d4d] to-[#43b3b0] rounded-br-[28px] px-4 py-8 text-white shrink-0">
    ...
    @if(auth()->user()->role == 'dokter')
        <ul class="space-y-3">
            ...
            <li>
                <a href="{{ route('Dokter.dashboardDokter') }}"
                   class="flex items-center gap-4 px-5 py-4 rounded-l-full transition-all duration-200
                   {{ request()->routeIs('Dokter.dashboardDokter') ? 'bg-white text-[#0f5c5c]' : 'text-white hover:bg-white/10' }}">
                    <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
                        <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/>
                    </svg>
            ...
            <li>
                <a href="{{ route('Dokter.permintaanDokter') }}"
                   class="flex items-center gap-4 px-5 py-4 rounded-l-full transition-all duration-200
                   {{ request()->routeIs('Dokter.permintaanDokter') ? 'bg-white text-[#0f5c5c]' : 'text-white hover:bg-white/10' }}">
                    <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
                        <path d="M20 4H4a2 2 0 00-2 2v12a2 2 0 002 2h16a2 2 0 002-2V6a2 2 0 00-2-2zm0 4l-8 5-8-5V6l8 5 8-5z"/>
                    </svg>
            ...
            <li>
                <a href="{{ route('Dokter.statusDokter') }}"
                   class="flex items-center gap-4 px-5 py-4 rounded-l-full transition-all duration-200
                   {{ request()->routeIs('Dokter.statusDokter') ? 'bg-white text-[#0f5c5c]' : 'text-white hover:bg-white/10' }}">
                    <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24">
